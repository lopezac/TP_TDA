...
# AXEL: si te anda lento, aumenta el numero de cpu conscientemente, en mi caso
# mi compu tiene 12 cpus, asi que le hardcodee un 10
MAX_WORKERS = 11#max(1, (os.cpu_count() or 0) // 4)
